...
![JMM(Java 内存模型)](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/jmm.png)

![JMM(Java 内存模型)强制在主存中进行读取](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/jmm2.png)
...
![image-20240409220910143](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/image-20240409220910143.png)
...
![synchronized关键字原理](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/synchronized-principle.png)
...
![执行 monitorenter 获取锁](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/synchronized-get-lock-code-block.png)

对象锁的的拥有者线程才可以执行 `monitorexit` 指令来释放锁。在执行 `monitorexit` 指令后，将锁计数器设为 0，表明锁被释放，其他线程可以尝试获取锁。

![执行 monitorexit 释放锁](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/synchronized-release-lock-block.png)
...
![image-20240409220929535](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/image-20240409220929535.png)
...
![](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/reentrantlock-class-diagram.png)
...
![](https://czynotebook.oss-cn-beijing.aliyuncs.com/notebook/reentrantreadwritelock-class-diagram.png)
