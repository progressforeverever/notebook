---
title: MySQL 15 如何正确地显示随机消息
date: 2023-12-20 19:28:38
permalink: /pages/5a6354/
categories:
  - 数据库与中间件
  - MySQL
tags:
...
![img](https://static001.geekbang.org/resource/image/78/ab/78d2db9a4fdba81feadccf6e878b4aab.png)
...
2. 用**随机函数生成一个最大值到最小值之间的数 X = (M-N)*rand() + N;**
3. 取不小于X的第一个ID的行。
