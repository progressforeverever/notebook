...
module.exports = {
  ...
  // bodyBgImg: [
  //   'https://czynotebook.oss-cn-beijing.aliyuncs.com/Ronaldo.jpg',
  //   'https://czynotebook.oss-cn-beijing.aliyuncs.com/machine.jpg',
  //   // 'https://czynotebook.oss-cn-beijing.aliyuncs.com/Hala%20Madrid.jpg',
  //   // 'https://czynotebook.oss-cn-beijing.aliyuncs.com/%E5%9D%9A%E6%AF%85%E7%9A%84%E7%9C%BC%E7%A5%9E.jpg',
  //   // 'https://czynotebook.oss-cn-beijing.aliyuncs.com/lcw01.jpg',
  ...
  author: {
    ...
    name: 'czy', // 必需
    link: 'https://github.com/progressforeverever', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: 'https://czynotebook.oss-cn-beijing.aliyuncs.com/%E4%BE%A7%E8%BE%B9%E6%A0%8F.jpeg',
    name: '学习笔记',
    slogan: '每个小菜鸡都有变强的梦想',
  },
  social: {
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: '1484311465@qq.com',
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/progressforeverever',
      },
    ],
  },
  footer: {
  ...
  indexImg: {  // 首页大图配置
    ...
    desc: ["嘿,你忘了划过伤口的冷风"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFadeIn 为 true 生效
